...
The project follows [Semantic Versioning](https://semver.org/). The API group is currently `v1alpha2`, meaning breaking changes to the CRD schema may occur in minor releases until the API is promoted to `v1beta1`.
