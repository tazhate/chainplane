...
A lightweight read-only web dashboard for visualising all `BlockchainNode` CRs in a Kubernetes cluster.
...
The dashboard only needs **read** access to `BlockchainNode` resources.
