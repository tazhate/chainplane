...
func makeNode(ns, name string, chain v1alpha1.Chain, phase v1alpha1.NodePhase) *v1alpha1.BlockchainNode {
	return &v1alpha1.BlockchainNode{
		ObjectMeta: metav1.ObjectMeta{
			Name:              name,
			Namespace:         ns,
			CreationTimestamp: metav1.Now(),
		},
		Spec: v1alpha1.BlockchainNodeSpec{
			Chain:   chain,
			Network: v1alpha1.NetworkMainnet,
		},
		Status: v1alpha1.BlockchainNodeStatus{
			Phase: phase,
		},
	}
}
...
func TestListNodes_MixedPhases(t *testing.T) {
	nodes := []runtime.Object{
		makeNode("default", "eth-1", v1alpha1.ChainEthereum, v1alpha1.NodePhaseHealthy),
		makeNode("default", "eth-2", v1alpha1.ChainEthereum, v1alpha1.NodePhaseSyncing),
		makeNode("default", "btc-1", v1alpha1.ChainBitcoin, v1alpha1.NodePhaseDegraded),
	}
...
func TestListNodes_Namespace(t *testing.T) {
	nodes := []runtime.Object{
		makeNode("ns-a", "eth-1", v1alpha1.ChainEthereum, v1alpha1.NodePhaseHealthy),
		makeNode("ns-b", "eth-2", v1alpha1.ChainEthereum, v1alpha1.NodePhaseHealthy),
	}
