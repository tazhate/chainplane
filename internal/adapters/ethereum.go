...
func (a *ethereumAdapter) ContainerPorts(spec nodesv1alpha1.BlockchainNodeSpec) []corev1.ContainerPort {
...
func (a *ethereumAdapter) ContainerArgs(spec nodesv1alpha1.BlockchainNodeSpec) []string {
