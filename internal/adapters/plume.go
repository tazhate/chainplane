...
func (a *plumeAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
	return "", "", nil
}
...
func (a *plumeAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
...
func (a *plumeAdapter) ContainerArgs(_ chainsv1alpha2.ChainInstanceSpec) []string {
