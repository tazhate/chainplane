...
func init() {
	Register(chainsv1alpha2.ChainStellar, &stellarAdapter{
		protocolAdapter: protocolAdapter{livenessPort: 11626},
	})
}
...
func (a *stellarAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainStellar, client)
}

func (a *stellarAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *stellarAdapter) ContainerCommand(_ chainsv1alpha2.ChainInstanceSpec) []string {
	return []string{
		"sh", "-c",
...
func (a *stellarAdapter) LivenessProbe(_ chainsv1alpha2.ChainInstanceSpec) *corev1.Probe {
	return tcpProbe(11626, 120, 30, 10, 10)
}

func (a *stellarAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
