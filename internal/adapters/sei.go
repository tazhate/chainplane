...
func init() {
	Register(chainsv1alpha2.ChainSei, &seiAdapter{
...
func (a *seiAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainSei, client)
}

func (a *seiAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *seiAdapter) StartupProbe(_ chainsv1alpha2.ChainInstanceSpec) *corev1.Probe {
