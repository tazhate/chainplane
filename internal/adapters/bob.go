...
func init() {
	Register(chainsv1alpha2.ChainBob, &bobAdapter{
...
func (a *bobAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainBob, client)
}

func (a *bobAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *bobAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
...
func (a *bobAdapter) ContainerArgs(_ chainsv1alpha2.ChainInstanceSpec) []string {
	return []string{"--metrics", "--metrics.addr", "0.0.0.0", "--metrics.port", "6060"}
}

// ContainerEnv injects the L1_RPC_URL environment variable required by the BOB OP Stack node.
func (a *bobAdapter) ContainerEnv(_ chainsv1alpha2.ChainInstanceSpec) []corev1.EnvVar {
