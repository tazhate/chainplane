...
func init() {
	Register(chainsv1alpha2.ChainLisk, &liskAdapter{
...
func (a *liskAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainLisk, client)
}

func (a *liskAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *liskAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
...
func (a *liskAdapter) ContainerArgs(_ chainsv1alpha2.ChainInstanceSpec) []string {
	return []string{"--metrics", "--metrics.addr", "0.0.0.0", "--metrics.port", "6060"}
}

// ContainerEnv injects the L1_RPC_URL environment variable required by the Lisk OP Stack node.
func (a *liskAdapter) ContainerEnv(_ chainsv1alpha2.ChainInstanceSpec) []corev1.EnvVar {
