...
func (a *worldchainAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainWorldchain, client)
}

func (a *worldchainAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *worldchainAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
...
func (a *worldchainAdapter) ContainerArgs(_ chainsv1alpha2.ChainInstanceSpec) []string {
...
func (a *worldchainAdapter) ContainerEnv(_ chainsv1alpha2.ChainInstanceSpec) []corev1.EnvVar {
