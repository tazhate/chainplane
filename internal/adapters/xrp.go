...
func init() {
	Register(chainsv1alpha2.ChainXRP, &xrpAdapter{
		protocolAdapter: protocolAdapter{livenessPort: 5005},
	})
}
...
func (a *xrpAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainXRP, client)
}

func (a *xrpAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *xrpAdapter) HealthCheck(ctx context.Context, rpcURL string) (SyncStatus, error) {
	...
	if err := json.Unmarshal(result, &resp); err != nil {
		return SyncStatus{}, fmt.Errorf("decode XRPL server_info payload: %w", err)
	}
...
func (a *xrpAdapter) LivenessProbe(_ chainsv1alpha2.ChainInstanceSpec) *corev1.Probe {
...
func (a *xrpAdapter) ContainerCommand(_ chainsv1alpha2.ChainInstanceSpec) []string {
	return []string{"rippled", "--conf=/config/rippled.cfg", "--net"}
}

func (a *xrpAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
