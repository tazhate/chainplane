...
func init() {
	Register(chainsv1alpha2.ChainTON, &tonAdapter{
		protocolAdapter: protocolAdapter{livenessPort: 30003},
	})
}
...
func (a *tonAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainTON, client)
}

func (a *tonAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *tonAdapter) ContainerCommand(_ chainsv1alpha2.ChainInstanceSpec) []string {
	return []string{
		"bash", "-c",
...
func (a *tonAdapter) HealthCheck(ctx context.Context, rpcURL string) (SyncStatus, error) {
	...
	if err != nil {
		return SyncStatus{}, fmt.Errorf("decode TON RPC URL: %w", err)
	}
	...
	if err != nil {
		return SyncStatus{}, fmt.Errorf("call TON seqno endpoint: %w", err)
	}
...
// state dump download.
func (a *tonAdapter) StartupProbe(_ chainsv1alpha2.ChainInstanceSpec) *corev1.Probe {
	return tcpProbe(30003, 300, 30, 10, 2880)
}

func (a *tonAdapter) LivenessProbe(_ chainsv1alpha2.ChainInstanceSpec) *corev1.Probe {
	return tcpProbe(30003, 60, 30, 10, 5)
}

// ContainerEnv injects PUBLIC_IP via Kubernetes Downward API (status.hostIP).
func (a *tonAdapter) ContainerEnv(_ chainsv1alpha2.ChainInstanceSpec) []corev1.EnvVar {
...
func (a *tonAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
...
func (a *tonAdapter) NodePorts(_ chainsv1alpha2.ChainInstanceSpec, name string) map[int32]int32 {
	offset := int32(0)
	switch {
