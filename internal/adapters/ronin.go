...
func init() {
	Register(chainsv1alpha2.ChainRonin, &roninAdapter{
...
func (a *roninAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainRonin, client)
}

func (a *roninAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *roninAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
	return append(evmPorts(30303), corev1.ContainerPort{Name: "metrics", ContainerPort: 6060, Protocol: corev1.ProtocolTCP})
}

func (a *roninAdapter) ContainerArgs(_ chainsv1alpha2.ChainInstanceSpec) []string {
