...
const defaultLineaL1URL = "http://ethereum-mainnet-01.blockchain-nodes.svc.cluster.local:8545"
...
// ContainerArgs provides CLI flags including the L1 RPC endpoint.
func (a *lineaAdapter) ContainerArgs(_ nodesv1alpha1.BlockchainNodeSpec) []string {
	return []string{"--config-file=/config/config.toml", "--plugin-linea-l1-rpc-endpoint=$(L1_RPC_URL)"}
}
