...
func init() {
	Register(chainsv1alpha2.ChainAxelar, &axelarAdapter{
...
func (a *axelarAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainAxelar, client)
}

func (a *axelarAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *axelarAdapter) DefaultResources() ResourceDefaults {
...
func (a *axelarAdapter) VersionPolicy() ChainVersionPolicy {
