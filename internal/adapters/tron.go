...
func init() {
	Register(chainsv1alpha2.ChainTRON, &tronAdapter{
		protocolAdapter: protocolAdapter{livenessPort: 8090},
	})
}
...
func (a *tronAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainTRON, client)
}

func (a *tronAdapter) ConfigTemplate(spec chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *tronAdapter) StartupProbe(spec chainsv1alpha2.ChainInstanceSpec) *corev1.Probe {
...
func (a *tronAdapter) ContainerCommand(_ chainsv1alpha2.ChainInstanceSpec) []string {
...
func (a *tronAdapter) ContainerArgs(_ chainsv1alpha2.ChainInstanceSpec) []string {
	return []string{"-c", "/config/config.conf", "-d", "/data"}
}

func (a *tronAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
