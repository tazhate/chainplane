...
func init() {
	Register(chainsv1alpha2.ChainDoma, &domaAdapter{
...
func (a *domaAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainDoma, client)
}

func (a *domaAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *domaAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
	return append(evmPorts(30303), corev1.ContainerPort{Name: "metrics", ContainerPort: 6060, Protocol: corev1.ProtocolTCP})
}

func (a *domaAdapter) ContainerArgs(_ chainsv1alpha2.ChainInstanceSpec) []string {
...
func (a *domaAdapter) ContainerEnv(_ chainsv1alpha2.ChainInstanceSpec) []corev1.EnvVar {
