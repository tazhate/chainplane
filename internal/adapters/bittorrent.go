...
func init() {
	Register(chainsv1alpha2.ChainBitTorrent, &bittorrentAdapter{
...
func (a *bittorrentAdapter) DefaultImage(client string) string {
	return DefaultImageFor(chainsv1alpha2.ChainBitTorrent, client)
}

func (a *bittorrentAdapter) ConfigTemplate(_ chainsv1alpha2.ChainInstanceSpec) (string, string, error) {
...
func (a *bittorrentAdapter) ContainerPorts(_ chainsv1alpha2.ChainInstanceSpec) []corev1.ContainerPort {
	return append(evmPorts(30303), corev1.ContainerPort{Name: "metrics", ContainerPort: 6060, Protocol: corev1.ProtocolTCP})
}

func (a *bittorrentAdapter) ContainerArgs(_ chainsv1alpha2.ChainInstanceSpec) []string {
