...
func testScheme() *runtime.Scheme {
	...
	utilruntime.Must(nodesv1alpha1.AddToScheme(s))
	return s
}

func testNode(name, ns string, chain nodesv1alpha1.Chain) *nodesv1alpha1.BlockchainNode {
...
func TestStartReplacement(t *testing.T) {
	...
	node := testNode("eth-node", "default", nodesv1alpha1.ChainEthereum)
	...
	var updated nodesv1alpha1.BlockchainNode
