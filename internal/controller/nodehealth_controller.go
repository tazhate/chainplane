...
// NodeHealthReconciler watches ChainInstance resources and performs
// trigger-based pod replacement using the internal/health subsystem. It runs
// alongside ChainInstanceReconciler without conflict: the main reconciler
...
// Reconcile performs a single health-check cycle for a ChainInstance.
//
...
func isCheckablePhase(phase chainsv1alpha2.NodePhase) bool {
	switch phase {
	case chainsv1alpha2.NodePhaseHealthy, chainsv1alpha2.NodePhaseSyncing, chainsv1alpha2.NodePhaseDegraded:
		return true
	default:
		return false
	}
...
// BlockchainType.
func mapChainToHealthType(chain chainsv1alpha2.Chain) health.BlockchainType {
	switch chain {
	case chainsv1alpha2.ChainEthereum, chainsv1alpha2.ChainEthereumArchive:
		return health.BlockchainEthereum
	case chainsv1alpha2.ChainSolana:
