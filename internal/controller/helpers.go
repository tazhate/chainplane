...
func lagThreshold(node *chainsv1alpha2.ChainInstance) int64 {
	if node.Spec.Health.BlockLagThreshold != nil {
		return *node.Spec.Health.BlockLagThreshold
	}
	switch node.Spec.Chain {
	case chainsv1alpha2.ChainBitcoin, chainsv1alpha2.ChainLitecoin, chainsv1alpha2.ChainDash:
...
func chainBlockTime(chain chainsv1alpha2.Chain) time.Duration {
	switch chain {
	...
	case chainsv1alpha2.ChainEthereum, chainsv1alpha2.ChainEthereumArchive:
...
func syncStallThreshold(chain chainsv1alpha2.Chain) time.Duration {
...
func coreLabels(node *chainsv1alpha2.ChainInstance) map[string]string {
...
func selectorLabels(node *chainsv1alpha2.ChainInstance) map[string]string {
...
func setCondition(node *chainsv1alpha2.ChainInstance, condType string, status metav1.ConditionStatus, reason, message string, now metav1.Time) {
...
func resolveContainerImage(node *chainsv1alpha2.ChainInstance, adapter adapters.ChainAdapter) string {
...
func containerCommand(adapter adapters.ChainAdapter, node *chainsv1alpha2.ChainInstance) []string {
...
func containerArgs(adapter adapters.ChainAdapter, node *chainsv1alpha2.ChainInstance) []string {
	var args []string
...
func containerEnv(node *chainsv1alpha2.ChainInstance) []corev1.EnvVar {
...
func appendJVMFlags(envs []corev1.EnvVar, node *chainsv1alpha2.ChainInstance) []corev1.EnvVar {
	if flags, ok := node.Annotations["chains.chainplane.io/jvm-flags"]; ok && flags != "" {
...
func (r *ChainInstanceReconciler) persistAnnotations(ctx context.Context, node *chainsv1alpha2.ChainInstance) error {
