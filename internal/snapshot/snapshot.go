...
func bucketForChain(chain nodesv1alpha1.Chain) string {
	switch chain {
	...
	case nodesv1alpha1.ChainArbitrum:
		return "snapshots-arbitrum"
	case nodesv1alpha1.ChainOptimism:
		return "snapshots-optimism"
	case nodesv1alpha1.ChainBase:
		return "snapshots-base"
	case nodesv1alpha1.ChainFantom:
		return "snapshots-fantom"
	case nodesv1alpha1.ChainGnosis:
		return "snapshots-gnosis"
	case nodesv1alpha1.ChainMantle:
		return "snapshots-mantle"
	case nodesv1alpha1.ChainBerachain:
		return "snapshots-berachain"
	case nodesv1alpha1.ChainCronos:
		return "snapshots-cronos"
	case nodesv1alpha1.ChainRonin:
		return "snapshots-ronin"
	case nodesv1alpha1.ChainCelo:
		return "snapshots-celo"
	case nodesv1alpha1.ChainBlast:
		return "snapshots-blast"
	case nodesv1alpha1.ChainMode:
		return "snapshots-mode"
	case nodesv1alpha1.ChainZora:
		return "snapshots-zora"
	case nodesv1alpha1.ChainTaiko:
		return "snapshots-taiko"
	case nodesv1alpha1.ChainZkSync:
		return "snapshots-zksync"
	case nodesv1alpha1.ChainLinea:
		return "snapshots-linea"
	case nodesv1alpha1.ChainScroll:
		return "snapshots-scroll"
	case nodesv1alpha1.ChainDogecoin:
		return "snapshots-doge"
	case nodesv1alpha1.ChainOsmosis:
		return "snapshots-osmosis"
	case nodesv1alpha1.ChainSei:
		return "snapshots-sei"
	case nodesv1alpha1.ChainEvmos:
		return "snapshots-evmos"
	case nodesv1alpha1.ChainKava:
		return "snapshots-kava"
	case nodesv1alpha1.ChainPolkadot:
		return "snapshots-polkadot"
	case nodesv1alpha1.ChainStarknet:
		return "snapshots-starknet"
	case nodesv1alpha1.ChainFilecoin:
		return "snapshots-filecoin"
	case nodesv1alpha1.ChainMoonbeam:
		return "snapshots-moonbeam"
	case nodesv1alpha1.ChainMoonriver:
		return "snapshots-moonriver"
	case nodesv1alpha1.ChainPolygonZkEVM:
		return "snapshots-polygon-zkevm"
	case nodesv1alpha1.ChainMantaPacific:
		return "snapshots-manta-pacific"
	case nodesv1alpha1.ChainMetis:
		return "snapshots-metis"
	case nodesv1alpha1.ChainFraxtal:
		return "snapshots-fraxtal"
	case nodesv1alpha1.ChainLisk:
		return "snapshots-lisk"
	case nodesv1alpha1.ChainKroma:
		return "snapshots-kroma"
	case nodesv1alpha1.ChainBob:
		return "snapshots-bob"
	case nodesv1alpha1.ChainBobaEth:
		return "snapshots-boba-eth"
	case nodesv1alpha1.ChainSoneium:
		return "snapshots-soneium"
	case nodesv1alpha1.ChainSwell:
		return "snapshots-swell"
	case nodesv1alpha1.ChainSuperseed:
		return "snapshots-superseed"
	case nodesv1alpha1.ChainInk:
		return "snapshots-ink"
	case nodesv1alpha1.ChainMorph:
		return "snapshots-morph"
	case nodesv1alpha1.ChainAbstract:
		return "snapshots-abstract"
	case nodesv1alpha1.ChainMegaETH:
		return "snapshots-megaeth"
	case nodesv1alpha1.ChainZeroNetwork:
		return "snapshots-zero-network"
	case nodesv1alpha1.ChainZircuit:
		return "snapshots-zircuit"
	case nodesv1alpha1.ChainImmutableZkEVM:
		return "snapshots-immutable-zkevm"
	case nodesv1alpha1.ChainWorldchain:
		return "snapshots-worldchain"
	case nodesv1alpha1.ChainUnichain:
		return "snapshots-unichain"
	case nodesv1alpha1.ChainLens:
		return "snapshots-lens"
	case nodesv1alpha1.ChainPlume:
		return "snapshots-plume"
	case nodesv1alpha1.ChainHemi:
		return "snapshots-hemi"
	case nodesv1alpha1.ChainAurora:
		return "snapshots-aurora"
	case nodesv1alpha1.ChainHarmony:
		return "snapshots-harmony"
	case nodesv1alpha1.ChainRootstock:
		return "snapshots-rootstock"
	case nodesv1alpha1.ChainTelos:
		return "snapshots-telos"
	case nodesv1alpha1.ChainKlaytn:
		return "snapshots-klaytn"
	case nodesv1alpha1.ChainShibarium:
		return "snapshots-shibarium"
	case nodesv1alpha1.ChainCore:
		return "snapshots-core"
	case nodesv1alpha1.ChainHaqq:
		return "snapshots-haqq"
	case nodesv1alpha1.ChainHashKey:
		return "snapshots-hashkey"
	case nodesv1alpha1.ChainEthereumClassic:
		return "snapshots-ethereum-classic"
	case nodesv1alpha1.ChainAxelar:
		return "snapshots-axelar"
	case nodesv1alpha1.ChainDymension:
		return "snapshots-dymension"
	case nodesv1alpha1.ChainBitTorrent:
		return "snapshots-bittorrent"
	case nodesv1alpha1.ChainGravityAlpha:
		return "snapshots-gravity-alpha"
	case nodesv1alpha1.ChainMoca:
		return "snapshots-moca"
	case nodesv1alpha1.ChainEverclear:
		return "snapshots-everclear"
	case nodesv1alpha1.ChainDoma:
		return "snapshots-doma"
	case nodesv1alpha1.ChainOpBNB:
		return "snapshots-opbnb"
	case nodesv1alpha1.ChainFuse:
		return "snapshots-fuse"
	case nodesv1alpha1.ChainThundercore:
		return "snapshots-thundercore"
	case nodesv1alpha1.ChainWemix:
		return "snapshots-wemix"
	case nodesv1alpha1.ChainViction:
		return "snapshots-viction"
	case nodesv1alpha1.ChainEthereumBeacon:
		return "snapshots-ethereum-beacon"
	case nodesv1alpha1.ChainGnosisBeacon:
		return "snapshots-gnosis-beacon"
	case nodesv1alpha1.ChainCronosZkEVM:
		return "snapshots-cronos-zkevm"
	case nodesv1alpha1.ChainSonic:
		return "snapshots-sonic"
	case nodesv1alpha1.ChainGoat:
		return "snapshots-goat"
	case nodesv1alpha1.ChainKatana:
		return "snapshots-katana"
	case nodesv1alpha1.ChainMezo:
		return "snapshots-mezo"
	case nodesv1alpha1.ChainPlasma:
		return "snapshots-plasma"
	case nodesv1alpha1.ChainPlaynance:
		return "snapshots-playnance"
	case nodesv1alpha1.ChainKusama:
		return "snapshots-kusama"
	case nodesv1alpha1.ChainHyperliquid:
		return "snapshots-hyperliquid"
	case nodesv1alpha1.ChainMonad:
...
func BuildInitContainer(chain nodesv1alpha1.Chain, cfg Config) corev1.Container {
	bucket := cfg.Bucket
	if bucket == "" {
	...
	preInstall := ""
	if chain == nodesv1alpha1.ChainLitecoin || chain == nodesv1alpha1.ChainEthereum {
